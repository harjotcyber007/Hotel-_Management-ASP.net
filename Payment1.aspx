<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Payment1.aspx.cs" Inherits="Payment" %>
        ...
        <table class="style1">
            ...
            <tr>
                <td class="style2">
                    Card Type</td>
                <td class="style2">
                    <asp:DropDownList ID="DropDownList1" runat="server" Height="30px" Width="167px">
            ...
            <tr>
                <td>
                    Card Number</td>
                <td>
                    <asp:TextBox ID="TextBox1" runat="server" MaxLength="16" Height="31px" 
            ...
            <tr>
                <td>
                    Name On Card</td>
                <td>
                    <asp:TextBox ID="TextBox2" runat="server" Height="31px" Width="167px"></asp:TextBox>
            ...
            <tr>
                <td>
                    Exp Date</td>
                <td>
                    <asp:TextBox ID="TextBox3" runat="server" Height="31px" Width="168px"></asp:TextBox>
            ...
            <tr>
                <td class="style3">
                    Cvv Code</td>
                <td class="style3">
                    <asp:TextBox ID="TextBox4" runat="server" Height="31px" Width="169px"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="Button1" runat="server" onclick="Button1_Click" 
                        Text="Pay Now" Height="50px" Width="176px" />
                </td>
            </tr>
        </table>
